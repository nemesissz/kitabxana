...
import { createRental, getMyRentals, getRentals, approveRental, rejectRental, markReturned, adminCreateRental } from './rental.controller.js';
...
router.post('/admin', authMiddleware, roleCheck(2), adminCreateRental);
